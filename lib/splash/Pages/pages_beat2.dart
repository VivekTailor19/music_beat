...
class Pages_Beat2 extends StatefulWidget {
  const Pages_Beat2({Key? key}) : super(key: key);

  @override
  State<Pages_Beat2> createState() => _Pages_Beat2State();
}

class _Pages_Beat2State extends State<Pages_Beat2> {
