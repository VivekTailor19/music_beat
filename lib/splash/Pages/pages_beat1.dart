...
class Pages_Beat1 extends StatefulWidget {
  const Pages_Beat1({Key? key}) : super(key: key);

  @override
  State<Pages_Beat1> createState() => _Pages_Beat1State();
}

class _Pages_Beat1State extends State<Pages_Beat1> {
